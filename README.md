...
### The website for students <a href="https://cugatepass.herokuapp.com/" target="_blank">(click to visit)</a>: 
...
### The Android app for Guards : 

Built on kodular.io (and MIT App Inventor based platform), this app serves as a gatepass/QR code scanner. The UI is very simple and easy to use. On scanning 
